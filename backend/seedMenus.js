...
const sampleMenus = [
  ...
  // Restaurant 9: Asian Fusion Kitchen
  {
    restaurantName: 'Asian Fusion Kitchen',
    category: 'appetizer',
    itemName: 'Edamame',
    description: 'Steamed soybeans with sea salt',
    price: 249,
    imageUrl: 'https://images.unsplash.com/photo-1583797227936-d9a5f0d5b9e5?w=300',
    allergenInfo: ['soy'],
    isVegetarian: true,
    isVegan: true,
    isGlutenFree: true,
  ...
  },
  {
    ...
    allergenInfo: ['peanuts', 'seafood', 'eggs'],
    isVegetarian: false,
    isVegan: false,
    isGlutenFree: true,
  },
  ...
  // Restaurant 10: Italian Trattoria
  {
  ...
  },
  {
    ...
    price: 249,
    imageUrl: 'https://images.unsplash.com/photo-1573140401552-388e5a2d1c0d?w=300',
    allergenInfo: ['gluten', 'dairy'],
    isVegetarian: true,
    isVegan: false,
    isGlutenFree: false,
  },
  {
    ...
    description: 'Classic pasta with eggs, bacon, and parmesan',
    price: 699,
  ...
  // Restaurant 11: Tex-Mex Cantina
  {
    restaurantName: 'Tex-Mex Cantina',
    category: 'appetizer',
  ...
  },
  {
    ...
    price: 349,
    imageUrl: 'https://images.unsplash.com/photo-1534939561126-855b8675edd7?w=300',
    allergenInfo: [],
    isVegetarian: true,
    isVegan: true,
    isGlutenFree: true,
  ...
  },
  {
    restaurantName: 'Tex-Mex Cantina',
    category: 'main',
    itemName: 'Vegetarian Quesadilla',
  ...
  },
  {
    ...
    price: 299,
    imageUrl: 'https://images.unsplash.com/photo-1599599810769-bcde5a160d32?w=300',
    allergenInfo: ['gluten'],
    isVegetarian: true,
    isVegan: false,
    isGlutenFree: false,
  },
  {
    restaurantName: 'Tex-Mex Cantina',
    category: 'beverage',
    itemName: 'Margarita (Non-Alcoholic)',
    description: 'Lime and salt mocktail',
    price: 249,
    imageUrl: 'https://images.unsplash.com/photo-1551538827-9c037cb4f32a?w=300',
    allergenInfo: [],
    isVegetarian: true,
    isVegan: true,
    isGlutenFree: true,
  ...
  // Restaurant 12: French Bistro
  {
    restaurantName: 'French Bistro',
    category: 'appetizer',
    itemName: 'French Onion Soup',
    description: 'Caramelized onions in beef broth with melted cheese',
    price: 449,
  ...
  },
  {
    ...
    category: 'appetizer',
    itemName: 'Escargot',
    description: 'Baked snails in garlic butter',
    price: 599,
  ...
  },
  {
    ...
    price: 999,
    imageUrl: 'https://images.unsplash.com/photo-1600891964092-4316c288032e?w=300',
    allergenInfo: [],
    isVegetarian: false,
    isVegan: false,
    isGlutenFree: true,
  },
  {
    ...
    price: 649,
    imageUrl: 'https://images.unsplash.com/photo-1572453800999-e8d2d1589b7c?w=300',
    allergenInfo: [],
    isVegetarian: true,
    isVegan: true,
    isGlutenFree: true,
  },
  {
    ...
    price: 399,
    imageUrl: 'https://images.unsplash.com/photo-1470124182917-cc6e71b22ecc?w=300',
  ...
  },
  {
    ...
    category: 'dessert',
    itemName: 'Macarons',
    description: 'Assorted French almond cookies',
    price: 349,
    imageUrl: 'https://images.unsplash.com/photo-1569864358642-9d1684040f43?w=300',
    allergenInfo: ['nuts', 'eggs'],
    isVegetarian: true,
    isVegan: false,
    isGlutenFree: true,
  },

  // Restaurant 13: BBQ Smokehouse
  {
    restaurantName: 'BBQ Smokehouse',
    category: 'appetizer',
    itemName: 'BBQ Ribs Appetizer',
    description: 'Smoked pork ribs with tangy BBQ sauce',
    price: 549,
  ...
  },
  {
    ...
    description: 'Slow-smoked pulled pork on a brioche bun',
    price: 649,
    imageUrl: 'https://images.unsplash.com/photo-1619740455993-557c2f48d58e?w=300',
    allergenInfo: ['gluten'],
    isVegetarian: false,
    isVegan: false,
    isGlutenFree: false,
  },
  {
    restaurantName: 'BBQ Smokehouse',
    category: 'main',
    itemName: 'Brisket Platter',
    description: 'Texas-style smoked brisket with sides',
    price: 1099,
  ...
  },
  {
    ...
    price: 299,
    imageUrl: 'https://images.unsplash.com/photo-1543339494-b4cd4f7ba686?w=300',
    allergenInfo: ['gluten', 'dairy'],
    isVegetarian: true,
    isVegan: false,
    isGlutenFree: false,
  },
  {
    ...
    category: 'side',
    itemName: 'Cornbread',
    description: 'Sweet and savory cornbread',
    price: 199,
    imageUrl: 'https://images.unsplash.com/photo-1618897996318-5a901fa6ca71?w=300',
    allergenInfo: ['gluten', 'dairy', 'eggs'],
    isVegetarian: true,
    isVegan: false,
    isGlutenFree: false,
  },
  {
    ...
    price: 349,
    imageUrl: 'https://images.unsplash.com/photo-1509461399763-ae67a981b254?w=300',
    allergenInfo: ['nuts', 'gluten', 'eggs'],
    isVegetarian: true,
    isVegan: false,
    isGlutenFree: false,
  },

  // Restaurant 14: Healthy Bowl Co.
  {
    restaurantName: 'Healthy Bowl Co.',
    category: 'main',
    itemName: 'Acai Bowl',
    description: 'Acai berry smoothie bowl with granola and fresh fruit',
    price: 499,
    imageUrl: 'https://images.unsplash.com/photo-1590301157890-4810ed352733?w=300',
    allergenInfo: [],
    isVegetarian: true,
    isVegan: true,
    isGlutenFree: true,
  },
  {
    ...
    category: 'main',
    itemName: 'Poke Bowl',
    description: 'Hawaiian-style raw fish with rice and vegetables',
    price: 749,
    imageUrl: 'https://images.unsplash.com/photo-1546069901-ba9599a7e63c?w=300',
    allergenInfo: ['fish', 'soy', 'sesame'],
    isVegetarian: false,
  ...
  },
  {
    restaurantName: 'Healthy Bowl Co.',
    category: 'beverage',
    itemName: 'Protein Smoothie',
    description: 'Banana, peanut butter, and protein powder blend',
    price: 399,
    imageUrl: 'https://images.unsplash.com/photo-1638176066666-ffb2f013c7dd?w=300',
    allergenInfo: ['peanuts', 'dairy'],
    isVegetarian: true,
    isVegan: false,
    isGlutenFree: true,
  },
  ...
  // Restaurant 15: Comfort Food Diner
  {
    restaurantName: 'Comfort Food Diner',
    category: 'main',
    itemName: 'Chicken Pot Pie',
    description: 'Creamy chicken and vegetables in flaky pastry',
    price: 699,
  ...
  },
  {
    ...
    category: 'main',
    itemName: 'Meatloaf',
    description: 'Classic meatloaf with mashed potatoes and gravy',
    price: 649,
    imageUrl: 'https://images.unsplash.com/photo-1603360946369-dc9bb6258143?w=300',
  ...
  },
  {
    ...
    price: 249,
    imageUrl: 'https://images.unsplash.com/photo-1585307876863-0c0f0b7c7e6a?w=300',
    allergenInfo: ['dairy'],
    isVegetarian: true,
    isVegan: false,
    isGlutenFree: true,
